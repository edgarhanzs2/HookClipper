...
import StylePickerModal, { RenderMode } from './StylePickerModal';
...
export default function ClipCard({ clip, index }: ClipCardProps) {
    ...
    const [stylePickerMode, setStylePickerMode] = useState<RenderMode>('vertical');
    ...
    const openStylePicker = (mode: RenderMode) => {
            ...
            >
                ...
                <div className="p-5">
                    ...
                    <div className="flex gap-2 mb-2">
                        ...
                        <div className="relative flex-1" ref={downloadMenuRef}>
                            <div className="flex rounded-xl overflow-hidden" style={{
                                ...
                                <a
                                    ...
                                    className="flex-1 py-3 text-sm font-bold text-white transition-all duration-300 hover:brightness-110 active:scale-[0.98] flex items-center justify-center gap-2 no-underline"
                                    style={{
                                ...
                                {clip.jobId && (
                                    <button
                                        ...
                                        className="px-2.5 text-white transition-all duration-200 hover:brightness-125 flex items-center"
                                        style={{
                            ...
                            {/* Dropdown menu */}
                            {showDownloadMenu && clip.jobId && (
                                <div
                                    className="absolute right-0 mt-2 w-56 rounded-xl overflow-hidden z-20 animate-fade-in"
                                    style={{
                                ...
                                >
                                    <button
                                        onClick={() => openStylePicker('landscape')}
                                        className="w-full text-left px-4 py-3 text-sm text-[var(--color-foreground)] transition-all duration-200 hover:bg-white/10 flex items-center gap-3"
                                    >
                                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                                            <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" strokeLinecap="round" strokeLinejoin="round" />
                                            <polyline points="7 10 12 15 17 10" strokeLinecap="round" strokeLinejoin="round" />
                                        ...
                                        <div>
                                            <div className="font-semibold">With Subtitles</div>
                                            <div className="text-xs text-[var(--color-foreground)]/40">Landscape + burned-in subs</div>
                                        </div>
                                    </button>
                                </div>
                            )}
                        ...
                        {clip.jobId && (
                            <button
                                onClick={() => openStylePicker('vertical')}
